...
(function(){
  ...
  hdr.innerHTML='<div><div style="font-size:10px;letter-spacing:.2em;color:#ffffff;text-transform:uppercase;font-weight:700;">◆ Experimental Tools</div>'
    ...
    +'<button id="exp-panel-close" style="background:none;border:1px solid rgba(255,255,255,0.2);color:#ff9742;font-size:9px;padding:4px 10px;cursor:pointer;border-radius:3px;font-family:inherit;line-height:1.4;flex-shrink:0;">Close</button>';
