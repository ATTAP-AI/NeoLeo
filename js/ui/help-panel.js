...
var SECTIONS = [
  ...
  },
  {
    ...
    body: '<p>These tools let you refine and transform your artwork in powerful ways:</p>' +
      ...
      '<li>'+L('Texture','.tbtn[data-t="texturemap"]','click:.tbtn[data-t="texturemap"]')+' \u2014 Overlay procedural texture patterns onto your artwork. The Texture Map picker panel provides 10 texture types with controls for <strong>Color</strong>, <strong>Scale</strong>, <strong>Opacity</strong>, <strong>Density</strong>, <strong>Size</strong> (25\u2013400% zoom), and <strong>Rotation</strong> (0\u2013360\u00b0). By default, clicking a texture replaces the canvas (discrete mode). Toggle <strong>Additive</strong> mode to layer multiple textures on top of each other for complex composite surfaces.</li>' +
  ...
  },
  {
    ...
    body: '<p>These are cutting-edge creative tools found only in NeoLeo. Open the '+L('Experimental Tools','#exp-toggle','open-section:exp-body')+' section at the bottom of the right panel:</p>' +
      ...
      '<li>'+L('Textures','#tex-toggle','open-exp:tex-body')+' \u2014 Procedural texture synthesis that generates surfaces from pure mathematics. Sixteen texture types across four families: <strong>Stone &amp; Mineral</strong> (Marble, Granite, Sandstone, Obsidian), <strong>Organic &amp; Natural</strong> (Wood Grain, Bark, Leather, Scales), <strong>Fabric &amp; Weave</strong> (Linen, Silk, Tweed, Chain Mail), and <strong>Industrial</strong> (Brushed Metal, Carbon Fiber, Circuit Board, Corrugated). Five sliders per texture control unique parameters. Textures generate both a color surface and a bump map for 3D integration \u2014 when a texture is active and you render a 3D shape, the texture is automatically mapped onto the surface with bump-perturbed normals for realistic surface relief.</li>' +
      '<li>'+L('3D','#td-toggle','open-exp:td-body')+' \u2014 Software 3D renderer that draws three-dimensional objects entirely on the 2D canvas. Twelve shapes are available: Sphere, Cube, Cylinder, Cone, Torus, Icosahedron, Octahedron, Capsule, Torus Knot, Superellipsoid, Spring, and M\u00f6bius Strip. Uses perspective projection, back-to-front painter\u2019s algorithm sorting, and Blinn-Phong shading with palette-driven materials. Nine sliders control resolution, zoom, rotation on three axes, light angle, specular intensity, wireframe overlay, and ambient light. Object Mode lets you capture a render and then move, resize, and rotate it interactively on the canvas before compositing to the active layer. The Animate button spins the shape continuously.</li>' +
  ...
  },
  {
    ...
    body: '<p>Scattered throughout NeoLeo you will find bright red <strong>Cycle</strong> buttons. These are your discovery tools \u2014 each click takes you on a guided tour through an entire family of algorithms, with every setting turned up to full expression so you can see each style at its most dramatic. Think of them as a slideshow of possibilities.</p>' +
      ...
      '<li>'+L('Textures Cycle','#tex-cycle-btn','open-exp:tex-body')+' \u2014 Tours all <strong>16 procedural textures</strong> across four families: Stone &amp; Mineral, Organic &amp; Natural, Fabric &amp; Weave, and Industrial. Each texture is generated entirely from noise functions, Voronoi cells, and mathematical models \u2014 no photographs involved.</li>' +
      '<li>'+L('3D Cycle','#td-cycle-btn','open-exp:td-body')+' \u2014 Steps through all <strong>12 three-dimensional shapes</strong>: Sphere, Cube, Cylinder, Cone, Torus, Icosahedron, Octahedron, Capsule, Torus Knot, Superellipsoid, Spring, and M\u00f6bius Strip. Each is rendered with Blinn-Phong shading and palette-driven materials.</li>' +
  ...
  },
  {
    ...
    body: '<p>The '+L('Showcase','#showcase-btn','click:#showcase-btn')+' is a curated gallery of <strong>92 pre-configured artworks</strong> spanning every engine, tool, and style in NeoLeo. It serves as both inspiration and a learning tool \u2014 each thumbnail shows you what a particular engine or tool combination can produce.</p>' +
      '<ul>' +
      '<li><strong>11 Categories</strong> \u2014 Artworks are organized by type: Generative Engines (48), Lighting Effects, Atmosphere & Post-Process, Humanize, Naturalize, Happy Hallucinations, Multi-Pass Blend, Experimental Tools, Chromatic Physics, 3D Objects, and Textures.</li>' +
