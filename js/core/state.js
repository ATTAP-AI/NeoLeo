...
/* ── Palette definitions ── */
const PALS={ember:{bg:'#080403',c:['#ff6200','#e8130a','#ffa500','#ff3a00','#c0320a','#ffd04c']},ink:{bg:'#f4efe4',c:['#0d0a06','#2a1f0a','#503c14','#8c6c28','#c49840','#e4c880']},ocean:{bg:'#010810',c:['#0a4f6e','#1280a0','#00b8d9','#40d8f0','#a0eef8','#d8f8ff']},neon:{bg:'#04000c',c:['#ff00e0','#00ffff','#8800ff','#ff0066','#00ff88','#ffee00']},earth:{bg:'#100c08',c:['#3a2010','#6a4020','#9c6830','#c89048','#dbb870','#e8d8a0']},ghost:{bg:'#f0f0f0',c:['#d8d8d8','#b0b0b0','#888','#505050','#282828','#101010']},aurora:{bg:'#010a0e',c:['#003d30','#00c88a','#00e8ff','#8833ff','#ff22aa','#ffdd44']},void:{bg:'#000000',c:['#ffffff','#c0c0c0','#808080','#404040','#202020','#101010']},rust:{bg:'#0c0806',c:['#6b2400','#a03a10','#cc6020','#e09040','#cca060','#e8d0a0']},botanic:{bg:'#060d06',c:['#0a3a14','#1a6a28','#40a040','#80c048','#c0e048','#f0f4c0']},anime:{bg:'#ffe8f2',c:['#ff4fa3','#e83494','#b66ae8','#5bd9e8','#a6f0c4','#ffe25e']}};
